                        ...
                        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                            ...
                            <div class="page-title-right">
                                <ol class="breadcrumb m-0">
                                    <li class="breadcrumb-item"><a href="javascript: void(0);">CountryCraft/a></li>
                                    ...
                                    <div class="col-sm-4">
                                        <div class="mt-4 mt-sm-0">
                                            <p class="mb-2 text-muted text-truncate"><i
                                                    class="mdi mdi-circle text-primary font-size-10 me-1"></i> This Year :
                                            </p>
                                            <div class="d-inline-flex">
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-4">
                                        <div class="text-center mt-4">
                                            <p class="mb-2 text-truncate"><i
                                                    class="mdi mdi-circle text-primary font-size-10 me-1"></i> Product A
                                            </p>
                                            <h5>42 %</h5>
                                        </div>
                                    </div>
                                    <div class="col-4">
                                        <div class="text-center mt-4">
                                            <p class="mb-2 text-truncate"><i
                                                    class="mdi mdi-circle text-success font-size-10 me-1"></i> Product B
                                            </p>
                                            <h5>26 %</h5>
                                        </div>
                                    </div>
                                    <div class="col-4">
                                        <div class="text-center mt-4">
                                            <p class="mb-2 text-truncate"><i
                                                    class="mdi mdi-circle text-warning font-size-10 me-1"></i> Product C
                                            </p>
                                            <h5>42 %</h5>
                                        </div>
                                    </div>
                                                ...
                                                <div class="conversation-list">
                                                    ...
                                                    <div class="ctext-wrap">
                                                        ...
                                                        <p class="chat-time mb-0"><i
                                                                class="mdi mdi-clock-outline align-middle me-1"></i> 12:09
                                                        </p>
                                                    </div>
                                            ...
                                            <li>
                                                <div class="conversation-list">
                                                    ...
                                                    <div class="ctext-wrap">
                                                        ...
                                                        <p class="chat-time mb-0"><i
                                                                class="mdi mdi-clock-outline align-middle me-1"></i> 10:00
                                                        </p>
                                                    </div>
                                    ...
                                    <table class="table table-centered datatable dt-responsive nowrap"
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td><a href="javascript: void(0);" class="text-reset fw-bold">#NZ1572</a>
                                                </td>
                                                <td>
                                                    04 Apr, 2020
                                                </td>
                                                ...
                                                <td>
                                                    <div class="badge bg-success-subtle text-success  font-size-12">Paid
                                                    </div>
                                                </td>
                                            ...
                                            <tr>
                                                ...
                                                <td><a href="javascript: void(0);" class="text-reset fw-bold">#NZ1571</a>
                                                </td>
                                                <td>
                                                    03 Apr, 2020
                                                </td>
                                                ...
                                                <td>
                                                    <div class="badge  bg-warning-subtle text-warning font-size-12">unpaid
                                                    </div>
                                                </td>
                                            ...
                                            <tr>
                                                ...
                                                <td><a href="javascript: void(0);" class="text-reset fw-bold">#NZ1570</a>
                                                </td>
                                                <td>
                                                    03 Apr, 2020
                                                </td>
                                            ...
                                            <tr>
                                                ...
                                                <td><a href="javascript: void(0);" class="text-reset fw-bold">#NZ1569</a>
                                                </td>
                                                <td>
                                                    02 Apr, 2020
                                                </td>
                                            ...
                                            <tr>
                                                ...
                                                <td><a href="javascript: void(0);" class="text-reset fw-bold">#NZ1568</a>
                                                </td>
                                                <td>
                                                    01 Apr, 2020
                                                </td>
                                                ...
                                                <td>
                                                    <div class="badge bg-danger-subtle text-danger font-size-12">Chargeback
                                                    </div>
                                                </td>
                                            ...
                                            <tr>
                                                ...
                                                <td><a href="javascript: void(0);" class="text-reset fw-bold">#NZ1567</a>
                                                </td>
                                                <td>
                                                    31 Mar, 2020
                                                </td>
                                            ...
                                            <tr>
                                                ...
                                                <td><a href="javascript: void(0);" class="text-reset fw-bold">#NZ1566</a>
                                                </td>
                                                <td>
                                                    30 Mar, 2020
                                                </td>
                                            ...
                                            <tr>
                                                ...
                                                <td><a href="javascript: void(0);" class="text-reset fw-bold">#NZ1565</a>
                                                </td>
                                                <td>
                                                    29 Mar, 2020
                                                </td>
                                            ...
                                            <tr>
                                                ...
                                                <td><a href="javascript: void(0);" class="text-reset fw-bold">#NZ1564</a>
                                                </td>
                                                <td>
                                                    28 Mar, 2020
                                                </td>
                                            ...
                                            <tr>
                                                ...
                                                <td><a href="javascript: void(0);" class="text-reset fw-bold">#NZ1563</a>
                                                </td>
                                                <td>
                                                    28 Mar, 2020
                                                </td>
            ...
            <div class="container-fluid">
                <div class="row text-center">
                    <div class="col-sm-12">
                        ...
                        </script> Manage by TFour Tech Pvt. Ltd | All Rights Reserved by ©
                        CountryCraftExports
