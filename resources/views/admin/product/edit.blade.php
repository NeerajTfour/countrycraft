                                        ...
                                        <form action="{{ route('product.update', $product->id) }}" method="POST"
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6 mb-3 form-group">
                                                    ...
                                                    <textarea name="short_description" id="" cols="30" rows="5" class="form-control">{{ $product->short_description }}</textarea>
